...
DESCRIPTION = metadata.get('description', 'Deep learning approaches applied to Fashion MNIST dataset')
AUTHOR = metadata.get('author', 'Maycown Miranda')
AUTHOR_EMAIL = metadata.get('author_email', 'maycowndouglas.om@gmail.com')
